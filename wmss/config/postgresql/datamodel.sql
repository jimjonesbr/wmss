...
CREATE TABLE wmss.wmss_noteset_attributes (
noteset_attribute_value VARCHAR PRIMARY KEY,
...
noteset_attribute_value VARCHAR REFERENCES wmss.wmss_noteset_attributes (noteset_attribute_value),
noteset_id BIGINT 
);

--select * from wmss.wmss_noteset_attributes
